        ...
        <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
          ...
          <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
            ...
            <p className=" font-normal text-base leading-6 text-gray-600 mt-2">
              What we’re about Want to go on adventure and explore the world but
              not sure where to start or who to go with? This is your community
              to find travel mates! Welcome to The New York International Travel
              Community, hosted by JoinMyTrip! We are a community of trustworthy
              travelers from around the world. For now, we will be hosting
              online webinars and events to bond over our shared passion for
              travel, discuss tips and ideas, and help connect travel lovers to
              make new friends and have memorable experiences! Join our
