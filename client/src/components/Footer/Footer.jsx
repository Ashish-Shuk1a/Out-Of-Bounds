...
const Footer = () => {
  return (
    <footer className="mt-32 bg-gradient-to-r from-cyan-500 to-blue-500 footer-bg text-qiskit-white flex flex-col gap-6 relative">
      <div className="hidden lg:block absolute top-4 left-[33rem]">
        <img src={GlobeShape} height={42} width={42} />
      </div>
      <div className="flex flex-col items-center lg:items-start lg:flex-row">
        <div className="cursor-pointer -mt-16 order-first lg:order-last ">
          <Tilt>
            <img src={Qiskit} alt="Out of Bounds" />
          </Tilt>
        </div>
                    ...
                    <ul key={idx1}>
                      ...
                      <div className="flex flex-col gap-6">
                        {link?.content.map((cont, idx2) => {
                          return (
                            <a href={cont.redirect} key={idx1 * idx2 + 1}>
      ...
      <div className="flex justify-center px-4 text-white">
        <p className="text-[0.9375rem] pb-2 text-center">
          Copyright © 2023 Out of Bounds . All Rights Reserved.
        </p>
      </div>

      <div className="absolute bottom-[4rem] -left-10 lg:bottom-0 lg:left-0">
        <img src={AlgeriaSymbol} height={74} width={107} />
      </div>
